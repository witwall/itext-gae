...
import com.google.code.appengine.awt.image.MemoryImageSource;
...
public class BarcodeDatamatrix {
    ...
    /**
     * Creates a <CODE>com.google.code.appengine.awt.Image</CODE>. A successful call to the method <CODE>generate()</CODE>
     * before calling this method is required.
     * @param foreground the color of the bars
     * @param background the color of the background
     * @return the image
     */    
    public com.google.code.appengine.awt.Image createAwtImage(Color foreground, Color background) {
        if (image == null)
            return null;
...
//        Canvas canvas = new Canvas();
        ...
        com.google.code.appengine.awt.Image img = com.google.code.appengine.awt.Image.createImage(new MemoryImageSource(w, h, pix, 0, w));
        return img;
    }
