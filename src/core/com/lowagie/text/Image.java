...
public abstract class Image extends Rectangle {
	...
	public static Image getInstance(com.google.code.appengine.awt.Image image, com.google.code.appengine.awt.Color color,
		...
		try {
			...
			throw new IOException(MessageLocalization.getComposedMessage("com.google.code.appengine.awt.image.interrupted.waiting.for.pixels"));
		}
		if ((pg.getStatus() & com.google.code.appengine.awt.image.ImageObserver.ABORT) != 0) {
			throw new IOException(MessageLocalization.getComposedMessage("com.google.code.appengine.awt.image.fetch.aborted.or.errored"));
		}
		int w = pg.getWidth();
		int h = pg.getHeight();
